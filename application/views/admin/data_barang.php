<div class="page-content">
	<div class="container-fluid">
		...
		<!-- Navigasi -->
		<div class="container-fluid">
			<button type="button" class="btn btn-primary mt-4">Data Barang</button>
			<a type="button" class="btn btn-secondary mt-4 ml-2" href="<?php echo base_url('admin/data_barang/tambah_barang/') ?>"><i class="fas fa-plus"></i> Tambah Data</a>
		</div>
		<!-- end navigasi -->
		...
		<div class="container-fluid">
			<div class="card mt-3">
				<div class="card-header">
					<h1 class="text-oren"><i class="fas fa-archive"></i> Data Barang</h1>
				</div>
				<div class="card-body">
					...
					<a class="btn btn-primary float-right mb-3" href="<?php echo base_url() . 'admin/data_barang/print_data_barang'; ?>" target="_blank" rel="nofollow"><i class="fas fa-print"></i> Print Data Barang</a>
					<!-- TABEL DATATABLES-->
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form method="post" action="<?php echo base_url() . 'admin/data_barang/update' ?>" enctype="multipart/form-data">
					...
					<div class="form-group row">
						<label for="colFormLabel" class="col-sm-3 col-form-label">Diskon</label>
						<div class="col-sm-2">
						...
						<div class="col-sm-5">
							<div class="input-group flex-nowrap">
								...
								<input type="number" class="form-control" name='hrg_diskon' id="hrg_diskon" aria-describedby="addon-wrapping">
							</div>
						</div>
					...
					<div class="form-group row">
						<label for="colFormLabel" class="col-sm-3 col-form-label">Harga Awal</label>
						<div class="col-5">
							<div class="input-group flex-nowrap">
								<div class="input-group-prepend">
									<span class="input-group-text" id="addon-wrapping">Rp.</span>
								</div>
								<input type="number" class="form-control" name='hrg_sblm_diskon' id="hrg_sblm_diskon" aria-describedby="addon-wrapping">
							</div>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-5">
							<div class="input-group flex-nowrap">
								...
								<input type="number" class="form-control" name='laba' readonly id="laba" " aria-describedby=" addon-wrapping">
							</div>
						</div>
					</div>
					...
					<table class="table table-borderless">
						<tr>
							...
							<td>
								...
								<div class="form-group row">
									<label class="col-sm-4 col-form-label">Hrg Awal</label>
									<div class="col-sm-8">
										<input type="text" name="hrg_sblm_diskon" id="hrg_sblm_diskon" class="form-control form-control-plaintext" readonly>
									</div>
								</div>
...
<script type="text/javascript">
	$(document).on("click", "#edit_brg", function() {
		...
		var hrg_sblm_diskon = $(this).data('hrg_sblm_diskon');
		...
		$("#modal_edit #tag").val(tag);
		$("#modal_edit #diskon").val(diskon);
		$("#modal_edit #hrg_sblm_diskon").val(hrg_sblm_diskon);
	...
	$(document).on("click", "#info_brg", function() {
		...
		$("#modal_info #tag").val(tag);
		$("#modal_info #diskon").val(diskon);
		$("#modal_info #hrg_sblm_diskon").val(hrg_sblm_diskon);
...
<script src="<?php echo base_url() ?>assets/js/jquery.js"></script>
<script type="text/javascript">
	$("#modal_edit #diskon").keyup(function() {
		var a = parseFloat($("#modal_edit #hrg_jual").val());
		var b = parseFloat($("#modal_edit #diskon").val());
		var c = a * b / 100;
		var d = a - c;

		$("#modal_edit #hrg_diskon").val(d);
	});
