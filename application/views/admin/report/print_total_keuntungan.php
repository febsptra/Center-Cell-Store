...
<body>
  <div class="container">
    ...
    <br>
    <h3 class="text-center"><b>DATA SELURUH KEUNTUNGAN</b></h3>
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        <?php
        $no = 1;
        foreach ($keuntungan as $kt) : ?>
          <tr>
            <td><?php echo $no++ ?> </td>
            <td><?php echo dateindo($kt->tgl) ?> </td>
            <td><?php echo $kt->nama_brg ?> </td>
            <td><?php echo rupiah($kt->hrg_jual) ?></td>
            <td><?php echo $kt->jumlah_jual ?></td>
            <td><?php echo rupiah($kt->total_harga) ?></td>
            <td><?php echo rupiah($kt->total_laba) ?></td>
          </tr>
        <?php endforeach; ?>
      </tbody>
    </table>
