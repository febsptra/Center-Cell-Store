<!-- GET DATA CHART-->
<?php
foreach ($keuntungan as $k => $v) {
  $arrProd[] = ['label' => $v->tgl_detail, 'y' => $v->total_laba];
}
?>
<!-- /.END GET DATA CHART-->
...
<div class="page-content">
  <div class="container-fluid">
    <div class="card w-110 mt-3" style="height: 45rem;">
      <h1 class="card-header text-oren"><i class="fas fa-chart-area"></i> Statistik Keuntungan :</h1>
      <div class="card-body">
        <!-- CARI Data -->
        <form class="form-validate" method="get" action="<?php echo base_url() . 'admin/report/total_keuntungan_tgl'; ?>">
          <div class="form-row">
            <div class="col-2">
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <a class="btn btn-primary mb-3" href="<?php echo base_url() . 'admin/report/total_keuntungan_print'; ?>" target="_blank" rel="nofollow"><i class="fas fa-print"></i> Print Seluruh Data Keuntungan</a>
        <br>
        <p>
          -- Atau --
        </p>
        <!-- CARI Data -->
        <form class="form-validate" method="get" action="<?php echo base_url() . 'admin/report/total_keuntungan_print_tgl'; ?>" target="_blank" rel="nofollow">
          <div class="form-row">
            <div class="col-4">
              <input type="date" name="tgl_awal" id="tgl_awal" class="form-control" required data-msg="Mohon Masukan Tanggal Awal." required>
            </div>
