<div class="page-content">
  <div class="container-fluid">
    <!-- Navigasi -->
    <div class="container-fluid">
      <a type="button" class="btn btn-primary mt-4" href="<?php echo base_url('admin/data_pembelian/index') ?>">Data Pembelian</a>
    ...
    <div class="container-fluid">
      <div class="card mt-3">
        <div class="card-header">
          <h1 class="text-oren"><i class="fas fa-search-plus"></i> Cari Barang yang Dibeli</h1>
        </div>
        <div class="card-body">
          <!-- TABEL DATATABLES-->
                    ...
                    <td>
                      ...
                      <a id=edit_brg data-toggle="modal" data-target="#modal_edit" data-no_brg="<?php echo $brg->no_brg ?>" data-nama_supplier="<?php echo $brg->nama_supplier ?>" data-kategori_brg="<?php echo $brg->kategori_brg ?>" data-nama_brg="<?php echo $brg->nama_brg ?>" data-hrg_beli="<?php echo $brg->hrg_beli ?>" data-hrg_jual="<?php echo $brg->hrg_jual ?>" data-laba="<?php echo $brg->laba ?>" data-stok_brg="<?php echo $brg->stok_brg ?>" data-keterangan="<?php echo $brg->keterangan ?>" data-foto_brg="<?php echo $brg->foto_brg ?>">
                        <button class="btn btn-primary ml-3">
                          <i class="fas fa-plus"></i> BELI</button></a>
                      <!-- /TOMBOL EDIT-->
                    </td>
                  </tr>
                <?php endforeach; ?>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <strong id="exampleModalLabel" class="modal-title"><i class="fas fa-cart-plus mr-2"></i> BELI BARANG</strong>
      ...
      <div class="modal-body">
        <!-- MODAL FORM -->
        <form class="form-validate" method="post" action="<?php echo base_url() . 'admin/data_pembelian/tambah_aksi'; ?>" enctype="multipart/form-data">
          <div class="form-group row">
            <label for="colFormLabel" class="col-sm-3 col-form-label">Tanggal Pembelian</label>
            <div class="col-sm-8">
              <input type="date" name="tgl_pembelian" id="tgl_pembelian" class="form-control" required data-msg="Mohon Masukan Tanggal Pembelian." required>
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input type="number" name="jumlah_beli" id="jumlah_beli" class="form-control numeric" required data-msg="Harap masukan Jumlah pembelian barang.">
            </div>
          </div>
          <div class="form-group row">
